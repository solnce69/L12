...
{
		ShowMessage(L"Колесиком мыши можно двигать синюю платформу вверх и вниз. Нажатием и удерживанием левой кнопкой мыши можно поворачивать конструкцию.");
}
//---------------------------------------------------------------------------
...
{
     ShowMessage(L"Данное приложение - это один из проектов движка GLScene для RAD Studio.");
}
//---------------------------------------------------------------------------
